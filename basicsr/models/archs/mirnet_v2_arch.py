...
class RRG(nn.Module):
    def __init__(self, n_feat, n_MRB, height, width, chan_factor, bias=False, groups=1):
        ...
        self.self_attention = SelfAttention(n_feat)
...
class MIRNet_v2(nn.Module):
    def __init__(self,
        ...
        modules_body.append(RRG(n_feat, n_MRB, height, width, chan_factor, bias, groups=4, self_attention=True)) # Added self-attention
